...
- **2026-09-06** Alan adı: `serkanoral.com.tr` (05.09 alındı, DNS'i yok). Vercel projesine eklendi; kayıt şirketinde NS `ns1/ns2.vercel-dns.com` ya da `A @ 76.76.21.21` girilince açılır. Sonra `NEXT_PUBLIC_SITE_URL=https://serkanoral.com.tr` env'i ve teklif mesajlarındaki linkler güncellenecek.
